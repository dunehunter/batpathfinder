...
public class BatPathFinderWindow extends JPanel implements ActionListener {
	...
	private final JComboBox<String> continentBox = new JComboBox<>(new String[] { "Laenor", "Desolathya", "Rothikgen", "Lucentium", "Furnachia", "Vlad" });
...
//		continentBox.setActionCommand("cont");
	...
	int getContinent() {
		...
		if ("Vlad".equals(cont)) { return AreaContainer.CONT_VLAD; }
		return -1;
	}
