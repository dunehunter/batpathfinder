...
public class AreaTest {
	...
	public void testArea() {
		...
		Costs c = null;
		try {
			tl = new Tradelanes("src/test/testdata/tradelane.txt", 4000, 5000, 4000, 5000, -4097, -4097);
			c = new Costs("src/test/testdata/costs", "src/test/testdata/costs.ship");
		} catch (Exception e) {
			fail("Exception");
		}
		...
		int ex = 0;
		try {
			Area a = new Area(tl, c, 10, 11, "src/test/testdata/test.map.illformed");
		} catch (IOException e) {
			ex = 1;
		}
		assertEquals(ex, 1);
		...
		ex = 0;
		try {
			Area a = new Area(tl, c, 10, 11, "src/test/testdata/test.map.illformed2");
		} catch (IOException e) {
			ex = 1;
		}
		assertEquals(ex, 1);
		...
		ex = 0;
		try {
			Area a = new Area(null, c, 10, 11, "src/test/testdata/test.map");
		} catch (IOException e) {
			ex = 1;
		}
		assertEquals(ex, 1);
		...
		ex = 0;
		try {
			Area a = new Area(tl, null, 10, 11, "src/test/testdata/test.map");
		} catch (IOException e) {
			ex = 1;
		}
		assertEquals(ex, 1);
		...
		ex = 0;
		try {
			Area a = new Area(tl, c, -1, 11, "src/test/testdata/test.map");
		} catch (IOException e) {
			ex = 1;
		}
		assertEquals(ex, 1);
		...
		ex = 0;
		try {
			Area a = new Area(tl, c, 10, -2, "src/test/testdata/test.map");
		} catch (IOException e) {
			ex = 1;
		}
		assertEquals(ex, 1);
		...
		ex = 0;
		try {
			Area a = new Area(tl, c, -4, -2, "src/test/testdata/test.map");
		} catch (IOException e) {
			ex = 1;
		}
		assertEquals(ex, 1);
		...
		try {
			Area a = new Area(tl, c, 10, 11, "src/test/testdata/test.map");
		} catch (Exception e) {
			fail("Exception");
		}
	}
	...
	public void testGetCost() {
		try {
			Tradelanes tl = new Tradelanes("src/test/testdata/tradelane.test.txt", 0, 10, 0, 11, 0, 0);
			Costs c = new Costs("src/test/testdata/costs", "src/test/testdata/costs.ship");
			Area a = new Area(tl, c, 10, 11, "src/test/testdata/test.map");
	...
	public void testGetPlaneLocationNeighbors() {
		try {
			Tradelanes tl = new Tradelanes("src/test/testdata/tradelane.empty.txt", 0, 10, 0, 11, 0, 0);
			Costs c = new Costs("src/test/testdata/costs", "src/test/testdata/costs.ship");
			Area a = new Area(tl, c, 10, 11, "src/test/testdata/test.map");
